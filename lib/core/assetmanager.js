...
var getUrl = function getUrl(url, base) {
...
function loadImage(url) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    image.onload = function loadImageOnLoad() {
      ...
      (0, _eventmanager.emit)("assetLoaded", this, url);
      resolve(this);
    };
...
function loadData(url) {
  ...
  return fetch(resolvedUrl).then(function (response) {
    ...
    (0, _eventmanager.emit)("assetLoaded", response, url);
    return response;
  });
}
/**
...
// // Sound Manager Code
// export let initSounds = sounds => {
//   sounds = sounds;
// };
// export let playSound = soundName => {
