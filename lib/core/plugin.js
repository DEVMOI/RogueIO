...
function registerPlugin(RogueIOObj, pluginObj) {
  var objectProto = RogueIOObj.prototype;
...
function unregisterPlugin(RogueIOObj, pluginObj) {
  var objectProto = RogueIOObj.prototype;
...
function extendObject(RogueIOObj, properties) {
  var objectProto = RogueIOObj.prototype;
